...
ili can talk back to its home repository (`intelligent-life-interface/ili`) in three ways.
...
* `ILI_GITHUB_ISSUES_REPO` — defaults to `intelligent-life-interface/ili`; forks can point it elsewhere.
