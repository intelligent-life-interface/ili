...
- **Code:** `board_service.create_board_immediate()` (Sync-Teil, idempotent via
  ...
  `BackgroundTasks`; **`fast:true` bleibt synchron** (Priority Widget +Knopf/Unterprojekt via
